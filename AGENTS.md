...
These directives are mandatory for all agents working in this repository. They replace previous Taskmaster/GitHub Actions slop and prevent circular debugging.
...
- No session/chat artifacts in commits (`.claude/*.json`, `.taskmaster/`, `.vscode/`, `.playwright-mcp/`, scratch files).
